#
#  Be sure to run `pod spec lint PhoneKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "PhoneKit"

  s.homepage     = "https://github.com/salah-mohammed/PhoneKit"
  ...
  s.source       = { :git => "https://github.com/salah-mohammed/PhoneKit.git", :tag => "#{s.version}",:branch => "master"}
